...
Sub AttachMessage(iwp As ISubclass, ByVal hWnd As Long, ByVal iMsg As Long, Optional AddressOp As Long = 0)
    ...
    If AddressOp <> 0 Then
        newProc = AddressOp
    Else
        newProc = HookAddress(AddressOf WindowProc)
    End If
    ' Validate window
    ...
    If c = 0 Then
        ...
        ProcOld = SetWindowLong(hWnd, GWL_WNDPROC, newProc)
